...
require 'slack-gamebot/api/presenters/report_presenter'
require 'slack-gamebot/api/presenters/reports_presenter'
require 'slack-gamebot/api/presenters/user_rank_presenter'
require 'slack-gamebot/api/presenters/user_ranks_presenter'
require 'slack-gamebot/api/presenters/user_team_presenter'
require 'slack-gamebot/api/presenters/user_teams_presenter'
