  ...
  $.ajax({
    ...
    success: function(data) {
      ...
      for(var i=0; i<users.length; i++){
        ...
        table.append( '<tr><td>' + user.rank + '</td><td>' + user_link + '</td><td>'+ (user.elo + 1200) + '</td><td>' + user.wins + '</td><td>' + user.losses + '</td><td>' + streakText + '</td><td>' + "W" + user.winning_streak + '</td><td>' + "L" + user.losing_streak + '</td></tr>' );
      }
